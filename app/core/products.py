...
所有后端价格、USDT 金额、是否代开通、有效期都从这里读取，
...
PRODUCTS: list[Product] = [
    # ChatGPT
    Product("GPT_PLUS_1M", "ChatGPT", "ChatGPT Plus 独享账号", 180, 20, "1个月", 30, True, legacy=True),
    ...
    Product("GPT_PLUS_1Y", "ChatGPT", "ChatGPT Plus 独享年卡", 1799, 240, "1年", 365, True),
    Product("GPT_TEAM_1M", "ChatGPT", "ChatGPT Team 席位", 260, 25, "1个月", 30, True),

    # Claude
    Product("CLAUDE_PRO_1M", "Claude", "Claude Pro 独享账号", 200, 20, "1个月", 30, True, legacy=True),
    ...
    Product("CLAUDE_PRO_1Y", "Claude", "Claude Pro 独享年卡", 1799, 204, "1年", 365, True),

    # Midjourney
    Product("MJ_BASIC_1M", "Midjourney", "Midjourney Basic", 120, 10, "1个月", 30, True, "AI绘画入门", "官方订阅 · 人工开通 · 适合低频出图和基础设计。"),
    Product("MJ_STANDARD_1M", "Midjourney", "Midjourney Standard", 279, 30, "1个月", 30, True, "⭐ 最多人选择", "官方订阅 · 人工开通 · 适合设计素材、海报、创意图。"),
    Product("MJ_PRO_1M", "Midjourney", "Midjourney Pro", 519, 60, "1个月", 30, True, "🔥 高性价比", "官方订阅 · 人工开通 · 适合设计师和高频出图用户。"),
    Product("MJ_MEGA_1M", "Midjourney", "Midjourney Mega", 999, 120, "1个月", 30, True, "👑 工作室推荐", "官方订阅 · 人工开通 · 适合高频创作、团队和工作室用户。"),

    # Gemini
    Product("GEMINI_PLUS_1M", "Gemini", "Gemini Plus", 99, 10, "1个月", 30, True, "入门推荐", "官方订阅 · 人工开通 · 适合日常AI使用与轻度多模态需求。"),
    Product("GEMINI_PRO_1M", "Gemini", "Gemini Pro", 189, 19, "1个月", 30, True, "🔥 主推套餐", "官方订阅 · 人工开通 · 更高额度、更强模型能力，适合高频用户。"),
    Product("GEMINI_ULTRA_1M", "Gemini", "Gemini Ultra", 1899, 199, "1个月", 30, True, "👑 高端套餐", "官方最高级订阅 · 人工开通 · 顶级模型权限和最高调用额度。"),
]

# 历史订单兼容：不再前台展示，但后台、查询、发货仍能识别。
LEGACY_PRODUCTS: list[Product] = [
    Product("GPT_ACTIVATE_3M", "ChatGPT", "ChatGPT Plus 季卡代开通（历史订单）", 499, 60, "3个月", 90, False, legacy=True),
    Product("GPT_PLUS_3M", "ChatGPT", "ChatGPT Plus 独享季卡（历史库存）", 499, 60, "3个月", 90, True, legacy=True),
    Product("CLAUDE_ACTIVATE_3M", "Claude", "Claude Pro 季卡代开通（历史订单）", 499, 60, "3个月", 90, False, legacy=True),
    Product("CLAUDE_PRO_3M", "Claude", "Claude Pro 独享季卡（历史库存）", 560, 60, "3个月", 90, True, legacy=True),
    Product("PERPLEXITY_PRO_1M", "更多AI工具", "Perplexity Pro 代开通（历史订单）", 120, 12, "1个月", 30, True, legacy=True),
    Product("CURSOR_PRO_1M", "更多AI工具", "Cursor Pro 代开通（历史订单）", 150, 15, "1个月", 30, True, legacy=True),
    Product("AI_BUNDLE_1M", "组合套餐", "AI全家桶月卡（历史订单）", 300, 30, "1个月", 30, True, legacy=True),
]
