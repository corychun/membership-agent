...
ROLE_PERMISSIONS: Dict[str, List[str]] = {
    "super_admin": ["orders:read", "orders:confirm", "inventory:read", "inventory:write", "admins:manage"],
    "manager": ["orders:read", "orders:confirm", "inventory:read", "inventory:write"],
    "support": ["orders:read", "inventory:read"],
}
